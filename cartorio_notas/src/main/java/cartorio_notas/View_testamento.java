 ...
 * @author Bruno
 */
public class View_testamento extends javax.swing.JFrame {
    ...
    private void hab_mask(){
        try {
            ...
            mask_cpf2.install(ftxt_cpf_testemunha);
    ...
    private void carregar_tabela(){
        ...
        for(int i = 0; i < testamentos.size(); i++){
            ...
            Object [] linha = {testamentos.get(i).getId(), testamentos.get(i).getId_funcionario(), testamentos.get(i).getCpf_testador(), testamentos.get(i).getCpf_testemunha()};
            model.addRow(linha);
        }
    ...
    private int editar_testamento(int edit_index){
        ...
        try{
            ...
            SimpleDateFormat formatted_date = new SimpleDateFormat("dd/MM/yyyy");
            Testamento testamento = testamentos.get(edit_index);
            
            ftxt_id.setText(Integer.toString(testamento.getId()));
            ftxt_id_funcionario.setText(Integer.toString(testamento.getId_funcionario()));
            ftxt_cpf.setText(testamento.getCpf_testador());
            ftxt_cpf_testemunha.setText(testamento.getCpf_testemunha());
            ftxt_data.setText(formatted_date.format(testamento.getData()));
    ...
    private int deletar_testamento(int delete_index){
        if(delete_index == -1){
            JOptionPane.showMessageDialog(this, "Selecione um item da lista", "Erro", JOptionPane.ERROR_MESSAGE);
            return 1;
        }
    ...
    private void initComponents() {
        ...
        ftxt_cpf_testemunha = new javax.swing.JFormattedTextField();
        ...
        lbl_title.setText("Cadastro de Testamentos");
        ...
        lbl_cpf.setText("Cpf do Testador");

        lbl_cpf_testemunha.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        lbl_cpf_testemunha.setText("Cpf da Testemunha");
            ...
            .addGroup(pnl_formLayout.createSequentialGroup()
                ...
                .addGroup(pnl_formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addGroup(pnl_formLayout.createSequentialGroup()
                        ...
                        .addGap(50, 50, 50)
                        .addGroup(pnl_formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(ftxt_cpf_testemunha, javax.swing.GroupLayout.PREFERRED_SIZE, 159, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(pnl_formLayout.createSequentialGroup()
                                .addGap(4, 4, 4)
                    ...
                    .addGroup(pnl_formLayout.createSequentialGroup()
                        .addGroup(pnl_formLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, pnl_formLayout.createSequentialGroup()
                                .addComponent(lbl_cpf_testemunha)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(ftxt_cpf_testemunha, javax.swing.GroupLayout.PREFERRED_SIZE, 24, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(pnl_formLayout.createSequentialGroup()
                                .addComponent(lbl_id)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void btn_editActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_editActionPerformed
        opcao = 1;
        desab_botoes(opcao);
        int editar = editar_testamento(tb_tabela.getSelectedRow());
        carregar_tabela();
    }//GEN-LAST:event_btn_editActionPerformed

    private void btn_deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_deleteActionPerformed

        int deletar = deletar_testamento(tb_tabela.getSelectedRow());
        carregar_tabela();
    ...
    private void btn_confirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_confirmActionPerformed
        ...
        switch (opcao){
            case 0:
            int cadastrar = cadastrar_testamento();
            break;
            ...
            for(int i = 0; i < testamentos.size(); i++){
                if(id == testamentos.get(i).getId()) testamentos.remove(i);
            }

            int editado = cadastrar_testamento();
            break;
    ...
    private javax.swing.JFormattedTextField ftxt_cpf_testemunha;
